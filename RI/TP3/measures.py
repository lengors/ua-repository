...
if __name__ == '__main__':
    ...
    for i in [ 10, 20, 50 ]:
        ...
        print(avg_formatter_header.format('Precision', 'Recall', 'F-Measure', 'Avg. Precision', 'NDCG'))
        print(avg_formatter_body.format(ap / len(queries), ar / len(queries), af / len(queries), aa / len(queries), an / len(queries)))
        print()
